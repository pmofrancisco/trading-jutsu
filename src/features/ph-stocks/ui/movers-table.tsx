import type { DailyMover } from '@/features/ph-stocks/data/dto';
import {
  formatPercent,
  formatPrice,
  formatPriceChange,
...
export default function MoversTable({
  ...
  return (
    <Table variant="secondary">
      {/* The one horizontal scroller: on a phone the five columns are wider
       * than the viewport, and without this the page itself would scroll. */}
