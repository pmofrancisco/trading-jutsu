import {
  listDailyMovers,
  MOVER_LIMIT,
} from '@/features/forex/data/daily-movers';
import DailyMoversTabs from '@/features/forex/ui/daily-movers-tabs';
import { formatDate } from '@/features/forex/ui/format';
    ...
    <div className="flex flex-col gap-4">
      <div className="flex flex-col gap-1">
        ...
        <p className="text-muted text-sm">
           ...
           * place. */}
          {asOf
            ? `The ${MOVER_LIMIT} biggest moves each way on ${formatDate(asOf)}, against each pair's previous close.`
