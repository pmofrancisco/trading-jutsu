...
/**
 * The section's landing page. It names the section and nothing else: the
 * figures that used to live here moved to `gainers-and-losers`, so that the
 * section's pages sit beside each other in the navigation rather than one of
 * them being the section itself.
 */
